...
export default function DigiflazzImportPage() {
                ...
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
                            Import Produk - Digiflazz
                        </h1>
                        <p className="text-gray-600 mt-2 font-medium">
                            Import produk game dari katalog Digiflazz dengan 2 metode
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            Import banyak produk sekaligus dengan memilih brand dari katalog Digiflazz.
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-bold text-lg hover:from-blue-600 hover:to-indigo-700 transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                        >
                    ...
                    <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            Import produk satu-per-satu menggunakan SKU/kode produk Digiflazz.
                        ...
                        <div className="bg-emerald-50 rounded-xl p-4 mb-6">
                            ...
                            <ul className="text-sm text-emerald-700 mt-2 space-y-1 ml-4">
                                <li>• Masukkan kode produk (contoh: ml5)</li>
                                <li>• Sistem fetch detail dari Digiflazz</li>
                        ...
                        <Link
                            href="/admin/topup/products/digiflazz/import-single"
                            className="w-full py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl font-bold text-lg hover:from-emerald-600 hover:to-teal-700 transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                        >
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-amber-800 space-y-1">
                                ...
                                <li>• Status produk sync otomatis dari Digiflazz</li>
